...
import com.foamtec.fa.web.AppUserController;
...
privileged aspect AppUserController_Roo_Controller {
    ...
    void AppUserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("appUser_createdate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("appUser_engineerupdatedate_date_format", "dd/MM/yyyy");
        uiModel.addAttribute("appUser_qcupdatedate_date_format", "dd/MM/yyyy");
    }
